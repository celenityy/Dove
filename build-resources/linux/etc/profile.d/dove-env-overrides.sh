...
readonly MOZ_DISABLE_ASAN_REPORTER=1
export MOZ_DISABLE_ASAN_REPORTER
...
readonly MOZ_CRASHREPORTER_DISABLE=1
readonly MOZ_CRASHREPORTER_NO_REPORT=1
readonly MOZ_CRASHREPORTER_URL='data;'
export MOZ_CRASHREPORTER
export MOZ_CRASHREPORTER_DISABLE
export MOZ_CRASHREPORTER_NO_REPORT
