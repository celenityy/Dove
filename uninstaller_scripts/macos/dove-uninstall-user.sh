...
/bin/rm -f ~/Applications/Thunderbird.app/Contents/Resources/defaults/pref/dove-bootstrap.js || error_fn
echo

echo_green_text "Removing dove-bootstrap.cfg..."
/bin/rm -f ~/Applications/Thunderbird.app/Contents/Resources/dove-bootstrap.cfg || error_fn
echo
