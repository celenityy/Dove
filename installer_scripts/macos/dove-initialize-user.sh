...
/usr/bin/xattr -v -r -d com.apple.quarantine ~/Applications/Thunderbird.app
...
/bin/chmod -v 644 dove-bootstrap.cfg || error_fn
echo

echo_green_text "Creating ~/Applications/Thunderbird.app/Contents/Resources/defaults/pref directory..."
/bin/mkdir -v -p ~/Applications/Thunderbird.app/Contents/Resources/defaults/pref || error_fn
echo
...
/bin/cp dove-bootstrap.js ~/Applications/Thunderbird.app/Contents/Resources/defaults/pref/dove-bootstrap.js || error_fn
echo

echo_green_text "Copying dove-bootstrap.cfg to ~/Applications/Thunderbird.app/Contents/Resources/dove-bootstrap.cfg.."
/bin/cp dove-bootstrap.cfg ~/Applications/Thunderbird.app/Contents/Resources/dove-bootstrap.cfg || error_fn
echo
